...
const copy = {
  en: {
    ...
    book: "Book a call",
    eyebrow: "Corporate hackathons for real business challenges in Latvia",
    hero: "One challenge. Dozens of fresh ideas. 24 or 48 hours.",
    intro: "We organise high-energy 24h and 48h corporate hackathons in Latvia, where student teams turn your company’s real challenge into concepts, prototypes and pitches.",
    explore: "Explore the formats",
    proof: "hackathons organised by our team",
  ...
  lv: {
    ...
    eyebrow: "Hakatonu organizēšana uzņēmumiem Latvijā",
    hero: "Viens izaicinājums. Desmitiem jaunu ideju. 24 vai 48 stundās.",
    intro: "Mēs organizējam enerģiskus 24h un 48h hakatonus uzņēmumiem Latvijā, kuros studentu komandas pārvērš reālus biznesa izaicinājumus konceptos, prototipos un pārliecinošās prezentācijās.",
    explore: "Apskatīt formātus",
    proof: "mūsu komandas organizēti hakatoni",
    ...
    <main lang={language}>
      <header className="site-header">
        ...
        <div className="header-actions">
          <div className="language-switch" aria-label="Language selector">
            ...
            <a className={language === "lv" ? "active" : ""} href="/lv" lang="lv" aria-current={language === "lv" ? "page" : undefined}>LV</a>
          </div>
      ...
      <section className="hero section-shell" id="top">
        <div className="hero-copy">
          ...
          <div className="proof-chip"><strong>50+</strong><span>{t.proof}</span></div>
        </div>
